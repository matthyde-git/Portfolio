...
describe('Detailed Project', async () => {
  ...
  it('renders the detailed project page, updates a project with valid information and checks it was updated successfully', async () => {
    ...
    deadline.value = "2025-06-22T15:00";
    ...
    expect(toastMessage.textContent).toBe("Project updated successfully");  // user successfully updates project (T13.1)
  })
});