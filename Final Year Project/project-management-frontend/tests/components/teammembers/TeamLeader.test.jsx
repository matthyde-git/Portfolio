...
describe('Team members', () => {
  ...
  it('renders the detailed project page where the user is the team leader, checks that the user is highlighted as the team leader', async () => {
    ...
    await waitFor(() => {
        const teamLeader = screen.getByTestId("team-leader");
        expect(teamLeader.textContent).toBe("Team Leader: test@email.com");
        expect(teamLeader.classList.contains("text-secondary")).toBe(true); // team leader is highlighted (T11.2)
    })
