...
describe('Team members', () => {
  ...
  it('renders the detailed project page where the user is the team leader, creates a invalid invitiation and checks the response message', async () => {
    ...
    expect(toastMessage.textContent).toBe("Cannot invite yourself to the project");  // user fails to create invite (T15.2)
