...
describe('Messages', () => {
  ...
  it('renders the message board for a project, sends a message and checks that it is present in the board', async () => {
    ...
    expect(messageInput).toBeRequired();  // prevents empty messages (T36.2)
    ...
    // await waitFor(() => {
    //     const newMessage = screen.getByTestId(10 + "message");
    //     expect(newMessage.textContent).toBe("Test message"); // message is created and displayed (T36.1)
    // })
