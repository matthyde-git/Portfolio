...
describe('Files', () => {
  ...
  it('renders the files for a project, checks that users can upload a file to the file input section', async () => {
    ...
    const exampleFile = new File(["example"], "example.png", {
        type: "image/png",
    });
    ...
    await waitFor(() => {
        ...
        userEvent.upload(selectFile, exampleFile);
        expect(selectFile.files).toHaveLength(1); // users can upload files (T29.1)
    })
