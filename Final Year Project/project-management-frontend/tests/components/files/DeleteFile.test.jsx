...
describe('Files', () => {
  ...
  it('deletes a file and checks that the response message is correct', async () => {
    ...
    await waitFor(() => {
      const deleteFileBtn = screen.getByTestId("test.txt-confirm-delete-file");
    ...
    // expect(toastMessage.textContent).toBe("File deleted successfully");  // user successfully deletes files (T30.1)
