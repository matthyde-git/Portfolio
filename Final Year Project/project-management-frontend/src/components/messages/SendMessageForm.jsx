...
const SendMessageForm = ({ refresh }) => {

    // form for the users to send messages to the project message board
    ...
    const handleSubmit = (e) => {
        ...
        // sends the message data to the messages backend, returns relevant toast message and notifies team
    ...
    {
        return (
            <form className="bg-base-100" id="message-form" onSubmit={handleSubmit}>
                ...
                <div className="join chat-input">
                    <textarea 
                        className="form-section textarea textarea-info join-item" 
                    ...
                    <button className="btn btn-info join-item chat-btn" data-testid="send-message-btn" type="submit">Send Message</button>
                </div>
